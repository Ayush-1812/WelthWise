...
/** System categories for the transfer legs, so they read correctly in the
 * personal ledger instead of being lumped into "Other Expenses" (M14). */
export const RECEIVABLE_CATEGORY = "shared-lent";
export const SETTLEMENT_SENT_CATEGORY = "shared-settlement";
export const SETTLEMENT_RECEIVED_CATEGORY = "shared-settlement-received";
...
export function personalEntryForSettlement({
  ...
  if (myUserId === fromUserId) {
    return {
      ...
      amount: value,
      category: SETTLEMENT_SENT_CATEGORY,
  ...
  if (myUserId === toUserId) {
    return {
      ...
      amount: value,
      category: SETTLEMENT_RECEIVED_CATEGORY,
